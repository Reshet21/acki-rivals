/**
 * api-lib/battle/cards.ts — каталог карт (серверная копия src/data/cards.ts).
...
export const clanBonuses: Record<string, { name: string; desc: string; effect: string; value: number }> = {
  'Неоновые Наемники': { name: 'Неоновая Энергия', desc: '+1 к силе всех карт клана', effect: 'clan_power', value: 1 },
  'Цифровые Монахи': { name: 'Монастырская Мудрость', desc: '+1 к урону всех карт клана', effect: 'clan_damage', value: 1 },
};
