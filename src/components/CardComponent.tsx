...
export default function CardComponent({ card, isSelected, onClick, compact, hand, noPopup }: Props) {
  ...
  const S = {
    btn: {
      ...
      boxShadow: `inset 0 0 0 2px rgba(255,255,255,0.05), ${r.fg}${sel ? ', 0 0 20px rgba(0,212,255,0.8)' : ''}`,
      outline: sel ? '2px solid #00d4ff' : 'none',
    ...
    label: { fontSize: C ? 6 : 7, color: 'rgba(255,255,255,0.5)', letterSpacing: '0.08em' } as React.CSSProperties,
        ...
        {!noPopup && (
          <div
            ...
            style={{
              ...
              fontSize: C ? 7 : 8, fontWeight: 700, color: '#00d4ff', cursor: 'pointer', zIndex: 10, lineHeight: 1,
              boxShadow: '0 0 8px rgba(0,212,255,0.35), 0 2px 6px rgba(0,0,0,0.5)',
